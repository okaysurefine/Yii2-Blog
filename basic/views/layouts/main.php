        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav text-uppercase">
                    <li><a href="<?= Url::toRoute(['/'])?>">Home</a></li></ul>
                    ...
                    <ul class="nav navbar-nav text-uppercase">
                        ...
                        <?php else: ?>
                            ...
                            . Html::submitButton(
                                ...
                                ['class' => 'btn btn-link logout', 'style'=>"padding-top:23px;"]
                            )
                            . Html::endForm() ?>
                        <?php endif;?>
                    </ul>
...
<footer class="footer-widget-section">
            ...
            <div class="col-md-4">
                <aside class="footer-widget">
                    ...
                    <div class="address">
                        ...
                        <p> 14529/12 NK Streets, DC, RU</p>

                        <p> Phone: +123 456 78900</p>

                        <p>github.com/okaysurefine</p>
                    </div>
                </aside>
            </div>
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2018 <a href="#">Blog PRO, </a> Built by <a href="https://github.com/okaysurefine">Leonid</a>
                    </div>
                </div>
            </div>
        </div>
